...
SceneTransforms.prototype.calculateOrtho = function(){
	mat4.identity(this.pMatrix);
	mat4.ortho(-c_width/2,c_width/2,-c_height/2,c_height/2, -10.0, 10.0, this.pMatrix);
};
...
SceneTransforms.prototype.updatePerspective = function(){
    mat4.perspective(45, c_width / c_height, 0.1, 1000.0, this.pMatrix);  // We can resize the screen at any point so the perspective matrix should be updated always.
};
SceneTransforms.prototype.updateOrtho = function(){
	mat4.ortho(-c_width/2,c_width/2,-c_height/2,c_height/2, -5000.0, 5000.0,this.pMatrix); // We can resize the screen at any point so the perspective matrix should be updated always.
};
