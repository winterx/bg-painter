var Scene = {
    ...
    // 01-19 请求模型库中的model文件
    loadObjectJson : function(filename) {
        $.get('data/models/' + filename + '.json', function(data,status){
            var o = {};
            o.alias = filename;
            o.width = 10;
            o.height = 10;
            ...
            o.rotation = [0,0,0];
            o.scale = [12,12,12];
            o.vertices = data.data.attributes.position.array;
            o.indices = data.data.index.array;
            o.scalars = [];

            var verticesNum = (o.vertices.length/3);
    ...
    // 11-28 请求本地由脚本生成的model文件
    requestObjectByLocalHost: function(alias) {
